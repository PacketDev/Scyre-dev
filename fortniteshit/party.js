...
express.post("/party/api/v1/Fortnite/parties", (req, res) => {
        var response = ""
   ...
   express.post("/party/api/v1/Fortnite/parties", (req, res) => {
    ...
    express.patch('/party/api/v1/Fortnite/parties/:partyId/members/:accountId/meta', (req, res) => {
                ...
                client.functions.SendMessage(JSON.stringify(
                    {
                        ...
                        "account_id": `FlowBot${counter != 0 ? counter : ''}`,
                        "account_dn": 'FlowBot',
    ...
    express.post('/party/api/v1/Fortnite/user/:accountId/pings/:pingerId', (req, res) => {
        res.json({
        ...
        if (req.params.accountId != "FlowBot") return;
    ...
    express.post('/party/api/v1/Fortnite/parties/:PartyId/members/*/join', (req, res) => { res.json({ "status": "JOINED", "party_id": req.params.PartyId }) })

    express.post("/party/api/v1/Fortnite/parties/LobbyBotPartyLMFAO/members/BOT/disconnect", (req, res) => { res.status(204).end()})

    express.post(`/party/api/v1/Fortnite/parties/:partyId/members/*/confirm`, (req, res) => { res.status(403).end() })

    express.patch("/party/api/v1/Fortnite/parties/:partyId", (req, res) => { res.status(204).send() })

    express.delete("/party/api/v1/Fortnite/parties/:partyId", (req, res) => { res.status(204).send() })

    express.all('/presence/api/v1/*', (req, res) => { res.json([]) })

    
    express.delete('/party/api/v1/Fortnite/parties/:PartyId/members/:accountId', (req, res) => {
        res.status(204).end()
        ...
        if (`${req.params.accountId}`.startsWith("FlowBot")) {
    ...
    express.post('/party/api/v1/Fortnite/parties/:PartyId/members/:accountId/promote', (req, res) => { res.status(204).end() })

    express.get('/party/api/v1/Fortnite/user/:accountId', (req, res) => {
    ...
    express.get("/party/api/v1/Fortnite/parties/:partyId", (req, res) => {
        res.json({
